...
/*
  Plugin Name: Contact Form 7 Store to DB Lite
  Plugin URI: http://accesspressthemes.com/wordpress-plugins/contact-form-7-store-to-db-lite
  Description: Plugin to easy store and manage contact form 7 entries manually into the WordPress without loosing the data.
  Version: 	1.0.4
...
if (!class_exists('Contact_form_7_store_to_db_lite')) {
    ...
    class Contact_form_7_store_to_db_lite {
        ...
        function define_constants() {
            ...
            defined('CF7STDBL_VERSION') or define('CF7STDBL_VERSION', '1.0.3');
