...
$labels = array(
    'name' => _x('CF7 Entries: Contact Form 7 Store to DB Lite', 'post type general name', 'contact-form-7-store-to-db-lite'),
    'singular_name' => _x('Contact Form 7 Store to DB Lite', 'post type singular name', 'contact-form-7-store-to-db-lite'),
    'menu_name' => _x('CF7 Entries', 'admin menu', 'contact-form-7-store-to-db-lite'),
    'name_admin_bar' => _x('Contact Form 7 Store to DB Lite', 'add new on admin bar', 'contact-form-7-store-to-db-lite'),
    'add_new' => _x('New', 'Contact Form 7 Store to DB Lite', 'contact-form-7-store-to-db-lite'),
